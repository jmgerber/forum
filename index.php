...
$traitementList = array('login', 'logout', 'register', 'compte', 'categorie', 'topic', 'messages', 'gestion', 'tchat', 'membres', 'informations');
...
$pageList = array('home', 'login', 'logout', 'register', 'compte', 'categorie', 'topics', 'messages', 'gestion', 'tchat', 'membres', 'informations');
$page = 'home';
